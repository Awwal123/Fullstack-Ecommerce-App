  ...
  return (
    <>
      ...
      <div className="w-full px-5 py-9 md:py-6 md:px-16 my-7">
        ...
        <Link to={"/home"}> <div className="mx-auto my-7 flex justify-center items-center rounded-md bg-[#DB4444] hover:bg-[#E07575] text-white text-center cursor-pointer  w-[254px] h-[56px]">
            Back to home page
          </div></Link>  
        </div>
      </div>
