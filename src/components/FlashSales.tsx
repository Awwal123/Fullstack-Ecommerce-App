...
export const FlashSale = () => {
  ...
  return (
    <div className="w-full  px-5 py-9 md:py-10 md:px-16">
      ...
      <div className="mt-10 grid grid-cols-2 overflow-auto m md:grid-cols-4  gap-4">
      {products.map ((product)=> (
        <div  key={product.id} className="w-[270px] h-auto bg-white pb-2 rounded-md shadow-sm">
            
                 <div className="relative group cursor-pointer  bg-gray-100 w-[270px] flex flex-col items-center rounded-t-md pt-3 h-[250px]">
                 {/* Discount Badge */}
                 ...
                 <div className="flex justify-center items-center ">
                   <img src={product.imgUrl} className="w-2/3 h-auto" alt={product.imgUrl} />
                 </div>
     
                 {/* Add to Cart Button (Hidden by Default) */}
                 <div className="w-full mt-auto">
                   <button className="bg-black w-full py-2 rounded-b-md text-white opacity-0 group-hover:opacity-100 transition-opacity">
                     Add To Cart
                   </button>
                 </div>
               </div>
